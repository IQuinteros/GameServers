...
<body>
    ...
    <main>
        <?php require_once('../php/components/project/experiments_toolbar.php') ?>
        <?php require_once('../php/components/project/experiments_info.php') ?>
    </main>

    <?php require_once('../php/components/footer.php') ?>

    <?php require_once('../php/components/project/experiments_popup.php') ?>
