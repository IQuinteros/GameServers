...
<head>
    ...
    <title>GameServers: Multiplayer</title>
...
<body>
    ...
    <main>
        <?php require_once('../php/components/features/multiplayer_cover.php') ?> 
        <?php require_once('../php/components/features/multiplayer_items.php') ?>
