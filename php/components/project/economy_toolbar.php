<div class="intranet__title">
    ...
    <a href="/project"><</a><h1>Ajustar economía</h1>
</div>

<div class="toolbar__limit">
    <div class="toolbar">
        <div class="toolbar__buttons">
            <button class="btn visible" onclick="onNewEconomy()">Nuevo</button>
            <button id="delete-btn" class="btn" onclick="onDeleteEconomy(selected)">Eliminar</button>
        </div>
